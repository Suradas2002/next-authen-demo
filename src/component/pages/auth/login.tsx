...
const Login =() =>  {
  ...
  console.log("check update session to use",session);
  ...
  const onSubmit = async (values: z.infer<typeof LogInSchema>) => {
    try {
      ...
      if (response.status === 200) {
        ...
        session.updateAuthStatus('authorized', userData, response.data.data.jwt);
          ...
          <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="divide-y divide-gray-200">
                <div className="py-8 pb-2 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            ...
            <div className="w-full flex justify-center pt-2">
              <button onClick={() => handleSocialLogin('google') } className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                <svg
